...
LABEL maintainer="Ben Neal bneal16@gmail.com"
...
RUN echo "**** Install Project Zomboid Dependencies ****" \
    && apt-get update \
    && apt-get install -y \
        openjdk-17-jre \
        rng-tools
...
# Add Valheim Configuraton Files
COPY vhserver/vhserver.cfg /home/linuxgsm/lgsm/config-lgsm/vhserver/vhserver.cfg
